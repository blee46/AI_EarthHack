...
def run_assistant(thread):
    assistant = client.beta.assistants.retrieve("asst_anh2CJR2D1gXn10bCpLMV2vL")
...
new_message = generate_response("Do you think it is a good idea to make the employees work 10 hours per day?", "123", "John")
new_message = generate_response("Do you think it is a good idea to learn how to recycle?", "234", "Dave")