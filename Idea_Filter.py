...
def run_assistant(thread):
    assistant = client.beta.assistants.retrieve("asst_nv9TfsiTMKu3PXmg5qRaEcFX")
...
new_message = generate_response("for corporate transparency, share information with employees or buy basketball tickets for yourself?", "123", "John")